    ...
    */
    calc_round_result: function(next) {
        ...
        if(betting_mode == 1) {
            ...
            //                     result_number = random.integer(1, 12);
            //                 }
            //                 console.log('result = ' + result_number);
            //                 cb(null, result_number);
            //             }
            //         });
            ...
            //             .exec(function(err, list) {
            //                 _.each(list, function(betting) {
            //                     var coins = Math.floor(betting.value * betting_rates[betting.level]);
            ...
            //         if(data != 0) {
            //             var result = new Result({betting_date: betting_date, round: round, result_number: data, betting_rates: betting_rates});
